...
(async function () {
    try {
        ...
        await WebAssembly.instantiateStreaming(wasm_promise, {
            js: {
        ...
        function renderNotFound() {
            ...
            domStatus.textContent = `[Declaration ${hash.slice(1)} not found]`;
            domStatus.classList.remove("hidden");
        ...
        function onHashChange(state) {
            ...
            if (!hash.startsWith("#main-doc")) {
                ...
                setTimeout(() => {
                    const obj = document.getElementById(hash.slice(1));
                    if (!obj) return;
